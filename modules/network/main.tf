...
# ---------------------------
# NAT Gateway(s) - lets private subnets reach internet (e.g. pull images, hit APIs)
# ---------------------------
...
# ALB SG: open to internet on 80/443
...
# RDS SG: only from ECS tasks
resource "aws_security_group" "rds" {
  name        = "${local.name_prefix}-rds-sg"
  description = "Allow inbound only from ECS tasks on db port"
  vpc_id      = aws_vpc.this.id
